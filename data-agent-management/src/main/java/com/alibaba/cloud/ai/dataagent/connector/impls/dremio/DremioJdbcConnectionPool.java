...
@Service("dremioJdbcConnectionPool")
public class DremioJdbcConnectionPool extends AbstractDBConnectionPool {
	...
	public boolean supportedDataSourceType(String type) {
		return BizDataSourceTypeEnum.DREMIO.getTypeName().equals(type);
	}
